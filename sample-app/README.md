...
was adapted to include the use of an API key, and some additional
logging for troubleshooting. These are minor mods, however, the buld of
this REST API sample is from the above repository.
